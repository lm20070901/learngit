...
<body>
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/words/createWords" method="post"  class="form form-horizontal" id="form-words-add">
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>名词：</label>
			<div class="formControls col-4">
				<input type="text" class="input-text" id="word" datatype="*" name="word" nullmsg="名词不能为空">
			</div>
			<div class="col-2"> </div>
		</div>
