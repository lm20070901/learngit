...
<body>
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/focusPicture/editFocusPicture" method="post"  class="form form-horizontal" id="form-focusPic-edit">
		<input type="text" style="display: none;" name="id" value="${data.picId }">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${data.title }" placeholder="请输入标题" id="title" datatype="*" name="title" nullmsg="分类名不能为空">
			</div>
			<div class="col-2"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${data.relatedLink }" placeholder="请输入外链地址" ignore="ignore" id="relatedLink" name="relatedLink" dataType="url" errormsg="地址格式错误">
			</div>
			<div class="col-2"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" name="articleId" value="${data.relatedArticleId }" id="articleId" style="display: none;">
				<input type="text" name="categoryId" id="categoryId" style="display: none;">
				<input type="text" class="input-text upload-url radius" value="${data.articleTitle }" readonly="readonly" placeholder="请选择关联文章" id="articleTitle">
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<div id="uploader" class="wu-example">
				    ...
				    <div class="btns">
					<input type="text" class="input-text upload-url radius" value="${data.linkDir }" id="linkDir" name="linkDir">
		...
		<div class="row cl">
			<label class="form-label col-2">是否可见：</label>
			<div class="formControls col-8">
				  <div class="radio-box">
				    <input type="radio" id="radio-1" name="visible" value="0" <c:if test="${data.isVisible == 0 }">checked</c:if>>
				    <label for="radio-1">可见</label>
				  </div>
				  <div class="radio-box">
				    <input type="radio" id="radio-2" name="visible" value="1" <c:if test="${data.isVisible == 1 }">checked</c:if>>
				    <label for="radio-2">不可见</label>
				  </div>
			</div>
		</div>
		<div class="row cl">
