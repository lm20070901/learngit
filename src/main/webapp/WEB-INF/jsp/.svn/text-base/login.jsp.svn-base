...
<link href="<%=request.getContextPath()%>/static/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<%=request.getContextPath()%>/toLogin" method="post">
      <div class="row cl">
...
<div class="footer">Copyright 经济日报</div>
