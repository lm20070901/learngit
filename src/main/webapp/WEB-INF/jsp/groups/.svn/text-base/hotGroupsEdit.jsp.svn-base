...
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/groups/editHotGroups" method="post"  class="form form-horizontal" id="form-news-edit">
		...
		<fieldset>
			<legend>编辑排序</legend>
			<div class="row cl">
				<input type="text" value="${data.groupId}" style="display: none;" name="groupId">
			</div>
			<div class="row cl">
				<label class="form-label col-2">名称：</label>
				<div class="formControls col-4">
					<input type="text" class="input-text" value="${data.groupName }" readonly="readonly">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2">热度排序：</label>
				<div class="formControls col-4">
