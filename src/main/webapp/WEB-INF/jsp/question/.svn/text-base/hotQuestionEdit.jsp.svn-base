...
<body>
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/question/modifyHotQuestionOrder" method="post"  class="form form-horizontal" id="form-hotQuestion-edit">
		<div class="row cl">
		<fieldset>
			<legend>编辑排序</legend>
			<div class="row cl">
				<input type="hidden" value="${data.questionId}" name="id">
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-4">
					<input type="text" value="${data.orderNum }" class="input-text" name="orderNum" dataType="n" errormsg="只能为数字">
				</div>
				<div class="col-2"> </div>
			</div>
		</fieldset>
...
$(function(){
	$("#form-hotQuestion-edit").Validform({
		tiptype:2,
