...
<body>
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/article/editArticle" method="post" class="form form-horizontal" id="form-article-edit">
		...
		<div class="row cl">
			...
			<c:if test="${contentType == 3 }">
				...
				<div class="formControls col-6">
					...
					<%-- <input type="text" name="mediaUrl" value="${article.fileUrl }" style="display: none;"> --%>
				</div>
			</c:if>
		</div>
		<div class="row cl">
