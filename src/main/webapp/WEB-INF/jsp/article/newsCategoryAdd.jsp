...
<body>
<div class="pd-20">
	<form action="<%=request.getContextPath()%>/article/addNewsCategory" method="post"  class="form form-horizontal" id="form-category-add">
		<div class="row cl">
		<fieldset>
			<legend>新增资讯分类</legend>
			<div class="row cl">
				<label class="form-label col-2 col-offset-2"><span class="c-red">*</span>分类名：</label>
				<div class="formControls col-4">
					<input type="text" class="input-text" value="" placeholder="请输入分类名称" id="categoryName" datatype="*" name="categoryName" nullmsg="分类名不能为空">
				</div>
			<div class="col-2"> </div>
			</div>
